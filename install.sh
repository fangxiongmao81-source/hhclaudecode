...
# free-code installer
# Usage: curl -fsSL https://raw.githubusercontent.com/fangxiongmao81-source/hhclaudecode/main/install.sh | bash
...
REPO="https://github.com/fangxiongmao81-source/hhclaudecode.git"
